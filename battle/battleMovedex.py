...
battleMovedex = {
    ...
    "metronome": {
        ...
        "priority": 0,
        "flags": {},
        "noMetronome": ["afteryou", "assist", "banefulbunker", "beakblast", "belch", "bestow", "celebrate", "chatter",
                        "copycat", "counter", "covet", "craftyshield", "destinybond", "detect", "diamondstorm",
                        "dragonascent", "endure", "feint", "fleurcannon", "focuspunch", "followme", "freezeshock",
                        "helpinghand", "holdhands", "hyperspacefury", "hyperspacehole", "iceburn", "instruct",
                        "kingsshield", "lightofruin", "matblock", "mefirst", "metronome", "mimic", "mindblown",
                        "mirrorcoat", "mirrormove", "naturepower", "originpulse", "photongeyser", "plasmafists",
                        "precipiceblades", "protect", "quash", "quickguard", "ragepowder", "relicsong", "secretsword",
                        "shelltrap", "sketch", "sleeptalk", "snarl", "snatch", "snore", "spectralthief", "spikyshield",
                        "spotlight", "steameruption", "struggle", "switcheroo", "technoblast", "thief",
                        "thousandarrows", "thousandwaves", "transform", "trick", "vcreate", "wideguard"],
        "secondary": False,
        "target": "self",
        "type": "Normal",
        "contestType": "Cute"
...
def get_type(move_name):
    """
    Returns the elemental type of the move given the name of the move
    as a String.
    :param move_name        The name of the move as a String.
...
def get_accuracy(move_name):
    """
    Returns the accuracy of the move given the name of the move.
    :param move_name        The name of the move as a String.
...
def get_boosts(move_name):
    """
    Returns a dictionary of boosts from the attack.
    :param move_name           The name of the move as a String.
