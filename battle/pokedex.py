...
def get_base_stats(species):
    ...
    :param species:
    :return:    A dictionary of the base stats.
    """
    stats = pokedex.get(species).get("baseStats")
    return stats


def get_types(species):
    """
    Returns a list of the types for the species given.
    :param species:
    :return:    A list of the types
    """
    types = pokedex.get(species).get("types")
    return types


def get_abilities(species):
    """
